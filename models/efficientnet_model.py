...
class PlantDiseaseModel(nn.Module):
    """
    EfficientNet-B3 plant disease classifier with custom classification head.
    """
    ...
    def _initialize_weights(self):
        """Initializes custom head weights using Kaiming Normal initialization."""
...
def create_model(
    ...
    """Factory function to instantiate and summarize the model."""
